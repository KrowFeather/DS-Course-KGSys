...
![AC\_automation\_gif\_b\_3.gif](../docs/string/images/ac-automaton1.gif)

我们重点分析结点 $6$ 的 fail 指针构建：

![AC\_automation\_6\_9.png](../docs/string/images/ac-automaton1.png)
...
![finish](../docs/string/images/ac-automaton4.png)
...
![AC\_automation\_gif\_b\_pro3.gif](../docs/string/images/ac-automaton2.gif)
...
![AC\_automation\_b\_7.png](../docs/string/images/ac-automaton2.png)
...
![AC\_automation\_b\_13.png](../docs/string/images/ac-automaton3.png)

我们从根结点开始尝试匹配 $\mathtt{ushersheishis}$，那么 $p$ 的变化将是：

![AC\_automation\_gif\_c.gif](../docs/string/images/ac-automaton3.gif)
