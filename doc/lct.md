...
![tree](../docs/ds/images/lct-atree-1.svg)

由刚刚的定义，辅助树的结构如图所示。

![auxtree](../docs/ds/images/lct-atree-2.svg)
...
-   我们有这样一棵树，实线为实边，虚线为虚边。
    ...
    ![initial tree](../docs/ds/images/lct-access-1.svg)

-   它的辅助树可能长成这样（构图方式不同可能 LCT 的结构也不同）。

    ![initial auxtree](../docs/ds/images/lct-access-2.svg)

-   现在我们要 `Access(N)`，把 $A$ 到 $N$ 路径上的边都变为实边，拉成一棵 Splay。

    ![access tree](../docs/ds/images/lct-access-3.svg)
