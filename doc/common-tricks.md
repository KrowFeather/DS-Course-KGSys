...
具体可参见 [循环展开 (Loop Unroll)](optimizations.md#循环展开-loop-unroll)、[代码布局优化 (Code Layout Optimizations)](optimizations.md#代码布局优化-code-layout-optimizations) 等内容
...
具体而言，对拍需要一个 [数据生成器](../docs/tools/testlib/generator.md) 和两个要进行输出结果比对的程序。
