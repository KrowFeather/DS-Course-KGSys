...
![dis-3-dimensional](../docs/geometry/images/distance-0.png)
...
![manhattan-dis-diff](../docs/geometry/images/distance-1.png)

在 $A,B$ 间，黄线、橙线都表示曼哈顿距离，而红线、蓝线表示等价的曼哈顿距离，绿线表示欧氏距离。

同样的例子，在下图中 $A,B$ 的坐标分别为 $A(25,20),B(10,10)$。

![manhattan-dis](../docs/geometry/images/distance-2.svg)
...
![Chebyshev-dis](../docs/geometry/images/distance-2.svg)
...
![dis-diff-square-1](../docs/geometry/images/distance-3.svg)
...
![dis-diff-square-2](../docs/geometry/images/distance-4.svg)
