...
![topo](../docs/graph/images/topo-example-1.svg)
...
因此我们可以说 在一个 [DAG（有向无环图）](drag2.md) 中，我们将图中的顶点以线性方式进行排序，使得对于任何的顶点 $u$ 到 $v$ 的有向边 $(u,v)$, 都可以有 $u$ 在 $v$ 的前面。
...
![topo](../docs/graph/images/topo-example-2.svg)
...
![topo](../docs/graph/images/topo-example.svg)
