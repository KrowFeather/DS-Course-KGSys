...
-   [筛法](sieve.md)
-   [最大公因数](gcd.md)
-   [欧拉函数](euler-totient.md)
-   [分解质因数](pollard-rho.md)

#### 2.9.5 组合计数

-   [排列组合](combination.md)
-   [抽屉原理](drawer-principle.md)
-   [容斥原理](inclusion-exclusion-principle.md)
