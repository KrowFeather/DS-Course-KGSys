...
![](../docs/math/images/order-theory1.svg)

由于偏序具有反对称性，所以 Hasse 图一定是 [有向无环图](drag2.md)，进而我们可以根据 [拓扑排序](topo.md) 对任意有限偏序集构造全序。
...
Dilworth 定理与 [Hall 婚配定理](graph-match.md#霍尔定理) 等价。
...
另请参阅：[排序相关 STL -  算法基础](stl-sort.md)。
