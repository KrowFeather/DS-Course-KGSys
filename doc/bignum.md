...
![](../docs/math/images/subtraction.png)
...
![](../docs/math/images/multiplication-short.png)
...
![](../docs/math/images/multiplication-long.png)
...
普通的多项式乘法时间复杂度仍是 $O(n^2)$，但可以用多项式一节中的 [快速傅里叶变换](fft.md)、[快速数论变换](ntt.md) 等算法优化，优化后的时间复杂度是 $O(n\log n)$。
