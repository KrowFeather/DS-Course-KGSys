...
[并查集](dsu.md)、[贪心](greedy.md)、[图的存储](save.md)。

### 实现

图示：

![](../docs/graph/images/mst-2.apng)
...
![eg](../docs/graph/images/mst-1.apng)
