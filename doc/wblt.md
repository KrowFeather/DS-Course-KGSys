...
![wblt-1](../docs/ds/images/wblt-1.svg)

我们首先找到了叶子节点 $5$，随后新建了一个非叶子节点 $D$，并将 $4$ 和 $5$ 连接到了 $D$ 上。

![wblt-2](../docs/ds/images/wblt-2.svg)
...
![wblt-7](../docs/ds/images/wblt-7.svg)
