...
![](../docs/ds/images/disjoint-set.svg)
...
![](../docs/ds/images/disjoint-set-find.svg)
...
![](../docs/ds/images/disjoint-set-compress.svg)
...
![](../docs/ds/images/disjoint-set-merge.svg)
...
[最小生成树算法](mst.md) 中的 Kruskal 和 [最近公共祖先](lca.md) 中的 Tarjan 算法是基于并查集的算法。
