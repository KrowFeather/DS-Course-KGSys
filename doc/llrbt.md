...
![llrbt1](../docs/ds/images/llrbt-1.png)

不符合条件的情况：

![llrbt2](../docs/ds/images/llrbt-2.png)
...
![llrbt3](../docs/ds/images/llrbt-3.png)

插入后，可能会产生一条右偏的红色边，因此需要对红边右偏的情况进行一次左旋：

![llrbt4](../docs/ds/images/llrbt-4.png)

考虑左旋后会产生两条连续的左偏红色边：

![llrbt5](../docs/ds/images/llrbt-5.png)

因此需要把它进行一次右旋。而对于右旋后的情况，我们应该对它进行 `color_flip`：即翻转该节点和它的两个儿子的颜色

![llrbt6](../docs/ds/images/llrbt-6.png)
...
![llrbt-7](../docs/ds/images/llrbt-7.png)

并且，在如上所示的翻转之后，不会使 `h->rc` 与 `h->rc->lc` 形成连续的红边；

但如果 `h->rc->lc` 是红色，情况会比较复杂：

![llrbt-8](../docs/ds/images/llrbt-8.png)
...
![llrbt-9](../docs/ds/images/llrbt-9.png)
