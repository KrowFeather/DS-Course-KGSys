...
1.  如图
    ...
    ![](../docs/math/linear-algebra/images/basis1.png)

    $u,v$ 是一组基。

2.  如图

    ![](../docs/math/linear-algebra/images/basis2.png)

    $u,v$ 是一组基。

3.  如图

    ![](../docs/math/linear-algebra/images/basis3.png)

    $u,v$ 不是一组基，因为 $u=-v$.

4.  如图

    ![](../docs/math/linear-algebra/images/basis4.png)
