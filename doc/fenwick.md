...
![](../docs/ds/images/fenwick-query.svg)
...
此外，逆序对的计数还可以通过 [归并排序](merge-sort.md#逆序对) 解决。这一方法可以避免离散化。时间复杂度同样为 $O(n\log n)$。两种算法的参考实现都在 [逆序对](permutation.md#逆序数) 章节。
