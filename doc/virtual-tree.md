...
![vtree-1](../docs/graph/images/vtree-tree.svg)

如果我们选取的关键点是：

![vtree-2](../docs/graph/images/vtree-key-vertex.svg)
...
![vtree-3](../docs/graph/images/vtree-vtree1.svg)

![vtree-4](../docs/graph/images/vtree-vtree2.svg)

![vtree-5](../docs/graph/images/vtree-vtree3.svg)

![vtree-6](../docs/graph/images/vtree-vtree4.svg)
...
![vtree-7](../docs/graph/images/vtree-add1.svg)

假如当前节点与栈顶节点的 LCA 不是栈顶节点的话：

![vtree-8](../docs/graph/images/vtree-add2.svg)

这时，当前单调栈维护的链是：

![vtree-9](../docs/graph/images/vtree-add3.svg)

而我们需要把链变成：

![vtree-10](../docs/graph/images/vtree-add4.svg)

那么我们就把用虚线标出的结点弹栈即可，在弹栈前别忘了向它在虚树中的父亲连边。

![vtree-11](../docs/graph/images/vtree-add5.svg)
...
![vtree-12](../docs/graph/images/vtree-construction1.svg)
...
![vtree-13](../docs/graph/images/vtree-construction2.svg)
...
![vtree-14](../docs/graph/images/vtree-construction3.svg)
...
![vtree-15](../docs/graph/images/vtree-construction4.svg)

-   结束了判断阶段，将 $6$ 入栈，当前栈为 $6,1$。

![vtree-16](../docs/graph/images/vtree-construction5.svg)
...
![vtree-17](../docs/graph/images/vtree-construction6.svg)

-   发现序列里的 3 个节点已经全部加入过栈了，退出循环。
-   此时栈中还有 3 个节点：$1,3,7$，很明显它们是一条链上的，所以直接链接：$1\to3$ 和 $3\to7$ 的边。
-   虚树就建完啦！

![vtree-18](../docs/graph/images/vtree-construction7.svg)

我们接下来将那些没入过栈的点（非青色的点）删掉，对应的虚树长这个样子：

![vtree-19](../docs/graph/images/vtree-construction8.svg)
