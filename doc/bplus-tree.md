...
![](../docs/ds/images/bplus-tree-1.png)
...
![](../docs/ds/images/bplus-tree-2.webp)

先和根节点比较

![](../docs/ds/images/bplus-tree-3.webp)

因为根节点的键值比 45 要小，所以去往根节点的右子树查找

![](../docs/ds/images/bplus-tree-4.webp)

因为 45 比 35 大，所以要与右边的索引相比

![](../docs/ds/images/bplus-tree-5.webp)

右侧的索引也为 45，所以要去往该节点的右子树继续查找

![](../docs/ds/images/bplus-tree-6.webp)
...
![](../docs/ds/images/bplus-tree-7.png)

由于插入节点 $[7,11]$ 在插入之后并没有溢出，所以可以直接变成 $[7,10,11]$。

![](../docs/ds/images/bplus-tree-8.png)

而如下图的 B+ 树中，插入数据 4：

![](../docs/ds/images/bplus-tree-9.png)

由于所在节点 $[2,3,5]$ 在插入之后数据溢出，因此需要分裂为两个新的节点，同时调整父节点的索引数据：

![](../docs/ds/images/bplus-tree-10.png)
