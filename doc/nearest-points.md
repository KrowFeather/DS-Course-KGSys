...
再根据 $B = \{ p_i \ \big | \ \lvert x_i - x_m \rvert < h \}$ 规则，得到绿色点组成的 $B$ 点集。![nearest-points1](../docs/geometry/images/nearest-points1.png)
...
![nearest-points2](../docs/geometry/images/nearest-points2.png)
...
![nearest-points3](../docs/geometry/images/nearest-points3.png)
...
首先将点对 [随机打乱](random.md#shuffle)，我们将维护前缀点集的答案。考虑从前 $i - 1$ 个点求出第 $i$ 个点的答案。

记前 $i - 1$ 个点的最近点对距离为 $s$，我们将平面以 $s$ 为边长划分为若干个网格，并存下每个网格内的点（使用 [哈希表](hash.md)），
