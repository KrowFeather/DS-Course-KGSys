...
import pandas as pd
df = pd.read_excel('./data/all_concepts.xlsx')
df.to_csv('./data/all_concepts.csv', index=False)
df = pd.read_excel('./data/concept_rel.xlsx')
df.to_csv('./data/concept_rel.csv', index=False)